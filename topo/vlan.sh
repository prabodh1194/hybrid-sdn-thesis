...
sudo ovs-vsctl del-port s14 s14-eth1
sudo ovs-vsctl add-port s14 s14-eth1 trunks=1,2,3,4
sudo ovs-vsctl del-port s4 s4-eth1
sudo ovs-vsctl add-port s4 s4-eth1 trunks=1,2,3,4
sudo ovs-vsctl del-port s18 s18-eth1
sudo ovs-vsctl add-port s18 s18-eth1 trunks=1,2,3,4
...
sudo ifconfig vlan41 10.0.1.253/24
sudo ifconfig vlan42 10.0.2.253/24
sudo ifconfig vlan43 10.0.3.253/24
sudo ifconfig vlan44 10.0.4.253/24
