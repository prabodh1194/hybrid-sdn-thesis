...
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.1.0/24,in_port=5,actions=mod_vlan_vid:4,set_field:$vlan34"->"eth_dst,set_field:$s1eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.2.0/24,in_port=5,actions=mod_vlan_vid:1,set_field:$vlan31"->"eth_dst,set_field:$s1eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.3.0/24,in_port=5,actions=mod_vlan_vid:2,set_field:$vlan32"->"eth_dst,set_field:$s1eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.4.0/24,in_port=5,actions=mod_vlan_vid:3,set_field:$vlan33"->"eth_dst,set_field:$s1eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.1.0/24,actions=mod_vlan_vid:4,set_field:$vlan34"->"eth_dst,set_field:$s1eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.2.0/24,actions=mod_vlan_vid:1,set_field:$vlan31"->"eth_dst,set_field:$s1eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.3.0/24,actions=mod_vlan_vid:2,set_field:$vlan32"->"eth_dst,set_field:$s1eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s14 ip,priority=2,nw_src=10.0.4.0/24,actions=mod_vlan_vid:3,set_field:$vlan33"->"eth_dst,set_field:$s1eth1"->"eth_src,output:5
