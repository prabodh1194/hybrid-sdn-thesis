...
ovs-ofctl -OOpenFlow13 add-flow s5 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.1.0/24,actions=set_field:$vlan12"->"eth_dst,mod_vlan_vid:2,set_field:$s1eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s5 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.2.0/24,actions=set_field:$vlan12"->"eth_dst,mod_vlan_vid:2,set_field:$s1eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s5 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.3.0/24,actions=set_field:$vlan13"->"eth_dst,mod_vlan_vid:3,set_field:$s1eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s5 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.4.0/24,actions=set_field:$vlan14"->"eth_dst,mod_vlan_vid:4,set_field:$s1eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s5 ip,priority=2,nw_src=10.0.2.0/24,in_port=5,actions=set_field:$vlan11"->"eth_dst,mod_vlan_vid:1,set_field:$s1eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s5 ip,priority=2,nw_src=10.0.3.0/24,in_port=5,actions=set_field:$vlan12"->"eth_dst,mod_vlan_vid:2,set_field:$s1eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s5 ip,priority=2,nw_src=10.0.4.0/24,in_port=5,actions=set_field:$vlan13"->"eth_dst,mod_vlan_vid:3,set_field:$s1eth1"->"eth_src,IN_PORT
...
ovs-ofctl -OOpenFlow13 add-flow s9 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.1.0/24,actions=set_field:$vlan22"->"eth_dst,mod_vlan_vid:2,set_field:$s2eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s9 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.2.0/24,actions=set_field:$vlan22"->"eth_dst,mod_vlan_vid:2,set_field:$s2eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s9 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.3.0/24,actions=set_field:$vlan23"->"eth_dst,mod_vlan_vid:3,set_field:$s2eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s9 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.4.0/24,actions=set_field:$vlan24"->"eth_dst,mod_vlan_vid:4,set_field:$s2eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s9 ip,priority=2,nw_src=10.0.2.0/24,in_port=5,actions=set_field:$vlan21"->"eth_dst,mod_vlan_vid:1,set_field:$s2eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s9 ip,priority=2,nw_src=10.0.3.0/24,in_port=5,actions=set_field:$vlan22"->"eth_dst,mod_vlan_vid:2,set_field:$s2eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s9 ip,priority=2,nw_src=10.0.4.0/24,in_port=5,actions=set_field:$vlan23"->"eth_dst,mod_vlan_vid:3,set_field:$s2eth1"->"eth_src,IN_PORT
...
ovs-ofctl -OOpenFlow13 add-flow s13 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.1.0/24,actions=set_field:$vlan32"->"eth_dst,mod_vlan_vid:2,set_field:$s3eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s13 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.2.0/24,actions=set_field:$vlan32"->"eth_dst,mod_vlan_vid:2,set_field:$s3eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s13 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.3.0/24,actions=set_field:$vlan33"->"eth_dst,mod_vlan_vid:3,set_field:$s3eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s13 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.4.0/24,actions=set_field:$vlan34"->"eth_dst,mod_vlan_vid:4,set_field:$s3eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s13 ip,priority=2,nw_src=10.0.2.0/24,in_port=5,actions=set_field:$vlan31"->"eth_dst,mod_vlan_vid:1,set_field:$s3eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s13 ip,priority=2,nw_src=10.0.3.0/24,in_port=5,actions=set_field:$vlan32"->"eth_dst,mod_vlan_vid:2,set_field:$s3eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s13 ip,priority=2,nw_src=10.0.4.0/24,in_port=5,actions=set_field:$vlan33"->"eth_dst,mod_vlan_vid:3,set_field:$s3eth1"->"eth_src,IN_PORT
...
ovs-ofctl -OOpenFlow13 add-flow s17 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.1.0/24,actions=set_field:$vlan42"->"eth_dst,mod_vlan_vid:2,set_field:$s4eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s17 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.2.0/24,actions=set_field:$vlan42"->"eth_dst,mod_vlan_vid:2,set_field:$s4eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s17 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.3.0/24,actions=set_field:$vlan43"->"eth_dst,mod_vlan_vid:3,set_field:$s4eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s17 ip,priority=2,nw_src=10.0.1.0/24,nw_dst=10.0.4.0/24,actions=set_field:$vlan44"->"eth_dst,mod_vlan_vid:4,set_field:$s4eth1"->"eth_src,output:5
ovs-ofctl -OOpenFlow13 add-flow s17 ip,priority=2,nw_src=10.0.2.0/24,in_port=5,actions=set_field:$vlan41"->"eth_dst,mod_vlan_vid:1,set_field:$s4eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s17 ip,priority=2,nw_src=10.0.3.0/24,in_port=5,actions=set_field:$vlan42"->"eth_dst,mod_vlan_vid:2,set_field:$s4eth1"->"eth_src,IN_PORT
ovs-ofctl -OOpenFlow13 add-flow s17 ip,priority=2,nw_src=10.0.4.0/24,in_port=5,actions=set_field:$vlan43"->"eth_dst,mod_vlan_vid:3,set_field:$s4eth1"->"eth_src,IN_PORT
